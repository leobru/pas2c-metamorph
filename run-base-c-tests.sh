#!/bin/bash
# Test runner for the tests-c/ C-declarator corpus through base-c.
# Mirrors runhotests.sh; see the-idea-is-to-kind-naur plan.
...
TESTS_DIR="tests-c"
RESULTS_DIR="test_results_basec"
RUNNER="run-base-c-test.sh"
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}base-c / tests-c Suite${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
